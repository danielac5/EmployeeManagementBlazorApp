...
public class CustomAutheticationStateProvider(LocalStorageService localStorageService) : AuthenticationStateProvider
{
    //this method is called anytime user is switching between pages
